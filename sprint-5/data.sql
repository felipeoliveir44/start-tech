...
('Sofá 3 lugares', 2500.00, 5),
('Clean Architecture', 102.90, 4),
('Mesa de jantar 6 lugares', 3678.98, 5),
('Iphone 13 Pro', 9176.00, 2),
('Monitor Dell 27', 1889.00, 3),
('Implementing Domain-Driven Design', 144.07, 4),
('Jogo de pneus', 1276.79, 1),
('Clean code', 95.17, 4),
('Galaxy S22 Ultra', 8549.10, 2),
('Macbook pro 16', 31752.00, 3),
('Refactoring Improving the Design of Existing Code', 173.90, 4),
('Cama queen size', 3100.00, 5),
('Central multimidia',711.18, 1),
('Building Microservices', 300.28, 4),
('Galaxy Tab S8',5939.10, 2);
